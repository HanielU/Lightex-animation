<script lang="ts">
  ...
  export const forwardAnim = () => {
    anime({
      targets: svg,
      rotateY: [
        { value: [0, 180], duration: 500 },
        { value: [180, 0], duration: 500, delay: 300 }
      ],
      easing: "linear"
    });
  };
...
>
  <g>
    <path
      d="M361.053,47.271H7.5c-4.143,0-7.5,3.358-7.5,7.5s3.357,7.5,7.5,7.5h353.553c4.143,0,7.5-3.358,7.5-7.5
		S365.195,47.271,361.053,47.271z"
    />
    <path
      d="M329.276,239.002l-84.165-66.983c-3.24-2.58-7.96-2.043-10.538,1.198c-2.579,3.241-2.043,7.959,1.198,10.539l67.367,53.615
    ...
    />
    <path
      d="M231.276,260.435c-3.823,0-6.923,3.1-6.923,6.923c0,22.099-17.979,40.077-40.077,40.077s-40.077-17.978-40.077-40.077
